h2. Notice, this plugin is modified based on my own requirement, it add several more functions such as folders, context menu, ETC.
Please make sure you know what you are doing if you want to use it. Good luck!
...
Add the following statement in environment.rb

@config.load_paths += %W(#{RAILS_ROOT}/vendor/plugins/rails-ckeditor/app/middleware)@
